...
<body class="bg-primary-subtle">
   <!--Navbar-->
   <nav class="navbar fixed-top navbar-expand-lg bg-dark shadow-sm justify-space-between">
      <div class="container-fluid">
         ...
         <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
               ...
               <li class="nav-item">
                  <a class="nav-link active text-light" aria-current="page" href="#aboutSection">About</a>
               </li>
               <li class="nav-item">
                  <a class="nav-link active text-light" aria-current="page" href="#footer">Contact</a>
               </li>
            </ul>
         </div>
      </div>
   ...
   <section id="homeSection" class="p-3">
      <div class="d-flex flex-wrap justify-content-center">
         <div class="col mt-5">
            <h2 class="fw-bold text-danger"><span class="text-warning">yu</span>Perpus</h2>
      ...
      <div id="carouselExampleControlsNoTouching " class="carousel slide" data-bs-touch="false">
         <div class="carousel-inner">
            <div class="carousel-item active">
               <img src="./assets/yu perpus.png" class="d-block w-100 rounded" alt="...">
            </div>
            <div class="carousel-item">
               <img src="./assets/yu perpus - Where Every Book Holds a Universe..png" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
               <img src="./assets/yu perpus Public Library.png" class="d-block w-100" alt="...">
            </div>
         </div>
